    ...
    final class EventDetailsViewController: UIViewController {
        ...
        private var incidentsHostingController: UIHostingController<IncidentsView>?
        ...
        private func addIncidentsSection() {
            let incidentsView = IncidentsView(eventId: viewModel.eventId, sport: viewModel.sport)
            ...
            incidentsHostingController = hosting
        }
